...
<head>
    ...
    <link rel="stylesheet" href="{{env('APP_URL')}}/css/blog/front.css" type="text/css">
    ...
    <div id="header-wrap">
        <div class="container">
            <div class="header-row">
                ...
                ============================================= -->
                <div id="logo">
                    <a href="#" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="{{env('APP_URL')}}/storage/images/logo.png" alt="Logo"></a>
                </div><!-- #logo end -->
...
<section id="page-title">
    ...
    <div class="container clearfix">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('posts')}}">Блог</a></li>
